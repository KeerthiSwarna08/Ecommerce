  ...
  return <footer className='border-t py-12'>
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        ...
        <div>
            ...
            <p><FiPhoneCall className="inline-block mr-2"/>+91 7842711628</p>
        </div>
    </div>
    {/* Footer bottom */}
    <div className='container mx-auto mt-12 lg:px-0 border-t border-gray-200 pt-6'></div>
        <p className='text-gray-500 text-sm text-center'>© 2021 E-Commerce. All Rights Reserved.</p>
  </footer>
}
