...
const FilterSidebar = () => {
  ...
  useEffect(()=>{
    ...
    // {category:'TopWear',maxPrice:100}=>params.category
    setFilters({
    ...
    <div className='mb-6'>
      ...
      {genders.map((gender)=>(
        <div key={gender} className='flex items-center mb-1'>
          <input type="radio" value={gender} onChange={handleFilterChange} checked={filters.gender===gender} name="gender" className="mr-2 h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300"/>
...
{/* Price Range Filter */}
      ...
      <input type="range" name="priceRange" min={0} max={1000} value={priceRange[1]} onChange={handlePriceChange} className='w-full h-2 bg-gray-300 rounded-lg appearance-none cursor-pointer'/>
