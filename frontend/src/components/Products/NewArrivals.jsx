    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto text-center mb-10 relative'>
            ...
            <p className='text-lg text-gray-600 mb-8'>
                Discover the latest trends in fashion and keep you wardrobe on the cutting edge of fashion.
            </p>
            {/* Scroll Button */}
        ...
        {/* Scrollable content */}
        <div ref={scrollRef} className={`container mx-auto overflow-x-scroll no-scrollbar flex space-x-6 relative ${isDragging? "cursor-grabbing":"cursor-grab"}`}
        onMouseDown={handleMouseDown} onMouseMove={handleOnMouseMove} onMouseUp={handleOnMouseUpOrLeave} onMouseLeave={handleOnMouseUpOrLeave}
        >
